          ...
          <header className="flex items-center justify-between gap-3">
            <div className="flex flex-col">
              ...
              <p className="text-xs text-slate-500 sm:text-sm dark:text-slate-400">
                Contas a receber, glosas, custos e indicadores financeiros.
              </p>
            </div>
          </header>
            ...
            <Card className="border-[#D9DEE3] bg-white/95 dark:border-slate-800 dark:bg-slate-900/90">
              <CardHeader>
                ...
                <CardDescription className="text-xs">
                  Área de controle financeiro será configurada aqui.
                </CardDescription>
              </CardHeader>
              <CardContent className="text-sm text-slate-600 dark:text-slate-300">
                Nesta seção poderemos incluir dashboards de fluxo de caixa,
                glosas a recuperar, custos por procedimento e outros indicadores
                financeiros importantes para a gestão.
              </CardContent>
            </Card>
          </main>
        </div>
