          ...
          <header className="flex items-center justify-between gap-3">
            <div className="flex flex-col">
              ...
              <p className="text-xs text-slate-400 sm:text-sm">
                Área exclusiva de administradores para definir CRM, telefone e clínicas vinculadas aos médicos.
              </p>
            </div>
            ...
            <div className="mt-2 flex flex-col gap-4">
              <section className="rounded-3xl bg-white/80 p-4 shadow-sm ring-1 ring-slate-100/80 dark:bg-slate-900/90 dark:ring-slate-800">
                <h2 className="flex items-center gap-2 text-base font-semibold text-slate-900 dark:text-slate-50">
                  ...
                  <span>Cadastro complementar do médico</span>
                </h2>
                <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                  Aqui você vincula médicos (já existentes na tabela de usuários com regra médico)
                  às clínicas/hospitais e registra CRM e telefone de WhatsApp para contato.
                </p>
              </section>
...
export default MedicosCadastro;