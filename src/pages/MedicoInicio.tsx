...
import { Upload, Activity, User2, Stethoscope } from "lucide-react";
...
const MedicoInicio: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0b] text-[#F5F5F5] relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-sm flex-col px-4 py-6 sm:px-5">
        {/* Header */}
